...
class AddDentistPage extends StatefulWidget {
  // const AddDentistPage({super.key});
  final Dentist? dentist;
  final bool isEdit;

  const AddDentistPage({
    super.key,
    this.dentist,
    this.isEdit = false,
  });
  ...
  @override
  State<AddDentistPage> createState() => _AddDentistPageState();
}

class _AddDentistPageState extends State<AddDentistPage> {
  ...
  void initState() {
    ...
    if (widget.isEdit && widget.dentist != null) {
      nameCtrl.text = widget.dentist!.name;
      specializationCtrl.text = widget.dentist!.specialization;
      experienceCtrl.text = widget.dentist!.experience;
      qualificationCtrl.text = widget.dentist!.qualification;
      imageCtrl.text = widget.dentist!.consultationTimings ?? "";
    }
  }
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "Enter dentist details to add to the directory",
                                  style: TextStyle(
                                    fontSize: 14,
                                ...
                                _input("Dentist Name", nameCtrl),
                                _input("Specialization", specializationCtrl),
                                _input("Experience (Years)", experienceCtrl),
                                _input("Qualification", qualificationCtrl),
                                    ...
                                    onPressed: () async {
                                      if (_formKey.currentState!.validate()) {
                                        ...
                                        if (widget.isEdit &&
                                          ...
                                          // 🟢 ADD dentist
                                          success = await provider.addDentist(
                                            nameCtrl.text,
                                            specializationCtrl.text,
                                            experienceCtrl.text,
                                            qualificationCtrl.text,
